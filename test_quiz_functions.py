...
@pytest.mark.parametrize(
    ...
    [([{"Pic ID": "ussr_kv_2", "Tank Name": "KV-2"}, {"Pic ID": "usa_m4a3e8", "Tank Name": "M4A3E8"},
      ...
      {"Pic ID": "ussr_kv_2", "Tank Name": "KV-2"}, ["KV-2", "M4A3E8", "IS-3", "Leopard 1"]),
     ([{"Pic ID": "ussr_kv_2", "Tank Name": "KV-2"}, {"Pic ID": "usa_m4a3e8", "Tank Name": "M4A3E8"},
       {"Pic ID": "ussr_is_3", "Tank Name": "IS-3"}, {"Pic ID": "germany_leopard_1", "Tank Name": "Leopard 1"}],
      {"Pic ID": "germany_leopard_1", "Tank Name": "Leopard 1"}, ["KV-2", "M4A3E8", "IS-3", "Leopard 1"]),
     ([{"Pic ID": "ussr_kv_2", "Tank Name": "KV-2"}, {"Pic ID": "usa_m4a3e8", "Tank Name": "M4A3E8"},
       {"Pic ID": "ussr_is_3", "Tank Name": "IS-3"}, {"Pic ID": "germany_leopard_1", "Tank Name": "Leopard 1"},
...
def test_create_random_answer_dict(random_question_key_set, random_quiz_value, expected_answer_dict_value):
    ...
    for question_key in range(random_answer_set):
        ...
        assert expected_answer_dict_value in random_answer_dict.values()

@pytest.mark.parametrize(
    "random_quiz_value, player_answer, player_input",
    [
	({"Pic ID": "ussr_kv_2", "Tank Name": "KV-2"}, "KV-2", 1),
	({"Tank Name": "KV-2", "Tank Class": "HT"}, "HT", 2),
	({"Tank Name": "KV-2", "Game Play": "Peek-A-Boo, Hit & Run, Circle Of Death, 1 vs 1 brawl."}, "Peek-A-Boo, Hit & Run, Circle Of Death, 1 vs 1 brawl.", 3)
	]
)
def test_check_correct_answer(random_quiz_value, player_answer, player_input):
    ...
    if player_input == 1:
        ...
        pass
    assert player_answer == correct_answer
